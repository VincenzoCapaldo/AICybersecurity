...
def run_fgsm(classifierNN1, classifierNN2, test_images, test_labels, test_set, targeted, accuracy_clean_nn1, accuracy_clean_nn2, targeted_accuracy_nn1_clean=0.0, targeted_accuracy_nn2_clean=0.0, target_class=None):
    ...
    ### Targeted (error-specific) FGSM Attack
        ...
        accuracies["nn1"].insert(0, accuracy_clean_nn1)
        accuracies["nn2"].insert(0, accuracy_clean_nn2)
        targeted_accuracy["nn1"].insert(0, targeted_accuracy_nn1_clean)
        targeted_accuracy["nn2"].insert(0, targeted_accuracy_nn2_clean)
        ...
        plot_accuracy("(NN1) FGSM Targeted - Accuracy and Targeted Accuracy vs Target Class and Max Perturbations", "Target Class", target_class_values, max_perturbations, accuracies["nn1"], targeted, targeted_accuracy["nn1"])
        plot_accuracy("(NN2) FGSM Targeted - Accuracy and Targeted Accuracy vs Target Class and Max Perturbations", "Target Class", target_class_values, max_perturbations, accuracies["nn2"], targeted, targeted_accuracy["nn2"])
...
def run_bim(classifierNN1, classifierNN2, test_images, test_labels, test_set, targeted, accuracy_clean_nn1, accuracy_clean_nn2, targeted_accuracy_nn1_clean=0.0, targeted_accuracy_nn2_clean=0.0, target_class=None):
    ...
    if not targeted:
        ...
        accuracies["nn1"].insert(0, accuracy_clean_nn1)
        accuracies["nn2"].insert(0, accuracy_clean_nn2)
        plot_accuracy(f"(NN1) BIM Non-targeted - Accuracy vs Epsilon and Max Perturbations (Epsilon_step={epsilon_step}; Max_iter={max_iter})", "Epsilon", epsilon_values, max_perturbations, accuracies["nn1"], targeted)
        plot_accuracy(f"(NN1) BIM Non-targeted - Accuracy vs Epsilon and Max Perturbations (Epsilon_step={epsilon_step}; Max_iter={max_iter})", "Epsilon", epsilon_values, max_perturbations, accuracies["nn2"], targeted)
        ...
        accuracies["nn1"].insert(0, accuracy_clean_nn1)
        accuracies["nn2"].insert(0, accuracy_clean_nn2)
        plot_accuracy(f"(NN1) BIM Non-targeted - Accuracy vs Epsilon Step and Max Perturbations (Epsilon={epsilon}; Max_iter={max_iter})", "Epsilon Step", epsilon_step_values, max_perturbations, accuracies["nn1"], targeted)
        plot_accuracy(f"(NN2) BIM Non-targeted - Accuracy vs Epsilon Step and Max Perturbations (Epsilon={epsilon}; Max_iter={max_iter})", "Epsilon Step", epsilon_step_values, max_perturbations, accuracies["nn2"], targeted)
        ...
        accuracies["nn1"].insert(0, accuracy_clean_nn1)
        accuracies["nn2"].insert(0, accuracy_clean_nn2)
        plot_accuracy(f"(NN1) BIM Non-targeted - Accuracy vs Max Iterations and Max Perturbations (Epsilon={epsilon}; (Epsilon_step={epsilon_step})", "Max Iterations", max_iter_values, max_perturbations, accuracies["nn1"], targeted)
        plot_accuracy(f"(NN2) BIM Non-targeted - Accuracy vs Max Iterations and Max Perturbations (Epsilon={epsilon}; (Epsilon_step={epsilon_step})", "Max Iterations", max_iter_values, max_perturbations, accuracies["nn2"], targeted)
    ...
    ### Targeted (error-specific) BIM attack
        ...
        plot_accuracy("(NN1) BIM Targeted - Accuracy and Targeted Accuracy vs Target Class and Max Perturbations", "Target Class", target_class_values, max_perturbations, accuracies["nn1"], targeted, targeted_accuracy["nn1"])
        plot_accuracy("(NN2) BIM Targeted - Accuracy and Targeted Accuracy vs Target Class and Max Perturbations", "Target Class", target_class_values, max_perturbations, accuracies["nn2"], targeted, targeted_accuracy["nn2"])
...
def run_pgd(classifierNN1, classifierNN2, test_images, test_labels, test_set, targeted, accuracy_clean_nn1, accuracy_clean_nn2, targeted_accuracy_nn1_clean=0.0, targeted_accuracy_nn2_clean=0.0, target_class=None):
    ...
    ### Targeted (error-specific) PGD attack
        ...
        plot_accuracy("(NN1) PGD Targeted - Accuracy and Targeted Accuracy vs Target Class and Max Perturbations", "Target Class", target_class_values, max_perturbations, accuracies["nn1"], targeted, targeted_accuracy["nn1"])
        plot_accuracy("(NN2) PGD Targeted - Accuracy and Targeted Accuracy vs Target Class and Max Perturbations", "Target Class", target_class_values, max_perturbations, accuracies["nn2"], targeted, targeted_accuracy["nn2"])
...
def main():
    ...
    targeted_accuracy_nn2_clean = compute_accuracy(classifierNN2, test_images_nn2, targeted_labels)
