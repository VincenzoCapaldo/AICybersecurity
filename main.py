...
def run_fgsm(classifier, test_images, test_labels, test_set, targeted=False):
    ...
    if not targeted:
        ...
        accuracies, average_perturbations, _ = fgsm(classifier, epsilon_values, test_images, test_labels, False)
    ...
    ### Targeted (error-specific) FGSM Attack
        ...
        accuracies, average_perturbations, targeted_accuracy = fgsm(classifier, epsilon_values, test_images, test_labels, True, target_class)
        ...
        accuracies, average_perturbations, targeted_accuracy = fgsm(classifier, epsilon, test_images, test_labels, True, target_class_values)
...
def run_bim(classifier, test_images, test_labels, test_set, targeted=False):
    ...
    if not targeted:
        ...
        epsilon_step = [0.01]
        max_iter = [5]
        accuracies, average_perturbations, _ = bim(classifier, epsilon_values, epsilon_step, max_iter, test_images, test_labels, False)
        ...
        max_iter = [5]
        accuracies, average_perturbations, _ = bim(classifier, epsilon, epsilon_step_values, max_iter, test_images, test_labels, False)
        ...
        accuracies, average_perturbations, _ = bim(classifier, epsilon, epsilon_step, max_iter_values, test_images, test_labels, False)
    ...
    ### Targeted (error-specific) BIM attack
        ...
        max_iter = [5]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = bim(classifier, epsilon_values, epsilon_step, max_iter, test_images, test_labels, True, target_class)
        ...
        max_iter = [5]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = bim(classifier, epsilon, epsilon_step_values, max_iter, test_images, test_labels, True, target_class)
        ...
        max_iter_values = [1, 2, 5, 10, 20]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = bim(classifier, epsilon, epsilon_step, max_iter_values, test_images, test_labels, True, target_class)
        ...
        max_iter = [5]
        target_class_values = test_set.get_used_labels()
        accuracies, average_perturbations, targeted_accuracy = bim(classifier, epsilon, epsilon_step, max_iter, test_images, test_labels, True, target_class_values)
...
def run_pgd(classifier, test_images, test_labels, test_set, targeted=False):
    ...
    if not targeted:
        ...
        epsilon_step = [0.01]
        max_iter = [5]
        accuracies, average_perturbations, _ = pgd(classifier, epsilon_values, epsilon_step, max_iter, test_images, test_labels, False)
        ...
        epsilon_step_values = [0.005, 0.01, 0.015, 0.02, 0.025]
        max_iter = [5]
        accuracies, average_perturbations, _ = pgd(classifier, epsilon, epsilon_step_values, max_iter, test_images, test_labels, False)
        ...
        epsilon_step = [0.01]
        max_iter_values = [1, 2, 5, 10, 20]
        accuracies, average_perturbations, _ = pgd(classifier, epsilon, epsilon_step, max_iter_values, test_images, test_labels, False)
    ...
    ### Targeted (error-specific) PGD attack
        ...
        max_iter = [5]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = pgd(classifier, epsilon_values, epsilon_step, max_iter, test_images, test_labels, True, target_class)
        ...
        max_iter = [5]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = pgd(classifier, epsilon, epsilon_step_values, max_iter, test_images, test_labels, True, target_class)
        ...
        max_iter_values = [1, 2, 5, 10, 20]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = pgd(classifier, epsilon, epsilon_step, max_iter_values, test_images, test_labels, True, target_class)
        ...
        max_iter = [5]
        target_class_values = test_set.get_used_labels()
        accuracies, average_perturbations, targeted_accuracy = pgd(classifier, epsilon, epsilon_step, max_iter, test_images, test_labels, True, target_class_values)
...
def run_df(classifier, test_images, test_labels):
    ...
    max_iter = [5]
    accuracies, average_perturbations, _ = deepfool(classifier, epsilon_values, max_iter, test_images, test_labels)
    ...
    epsilon = [0.05]
    max_iter_values = [1, 2, 5, 10, 20]
    accuracies, average_perturbations, _ = deepfool(classifier, epsilon, max_iter_values, test_images, test_labels)
...
def run_cw(classifier, test_images, test_labels, test_set, targeted=False):
    ...
    if not targeted:
        ...
        max_iter = [5]
        learning_rate = [0.01]
        accuracies, average_perturbations, _ = carlini_wagner(classifier, confidence_values, max_iter, learning_rate, test_images, test_labels)
        ...
        learning_rate = [0.01]
        accuracies, average_perturbations, _ = carlini_wagner(classifier, confidence, max_iter_values, learning_rate, test_images, test_labels)
        ...
        accuracies, average_perturbations, _ = carlini_wagner(classifier, confidence, max_iter, learning_rate_values, test_images, test_labels)
    ...
    ### Targeted (error-specific) Carlini-Wagner attack
        ...
        learning_rate = [0.01]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = carlini_wagner(classifier, confidence_values, max_iter, learning_rate, test_images, test_labels, True, target_class)
        ...
        learning_rate = [0.01]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = carlini_wagner(classifier, confidence, max_iter_values, learning_rate, test_images, test_labels, True, target_class)
        ...
        learning_rate_values = [0.001, 0.005, 0.01, 0.05, 0.1]
        target_class = test_set.get_true_label("Cristiano_Ronaldo")
        accuracies, average_perturbations, targeted_accuracy = carlini_wagner(classifier, confidence, max_iter, learning_rate_values, test_images, test_labels, True, target_class)
        ...
        learning_rate = [0.01]
        target_class_values = test_set.get_used_labels()
        accuracies, average_perturbations, targeted_accuracy = carlini_wagner(classifier, confidence, max_iter, learning_rate, test_images, test_labels, True, target_class_values)
...
def main():
    ...
    elif args.attack == "carlini_wagner":
